GET DATA  /TYPE=TXT
  /FILE="F:\PIT\correct_all\OCD\results\ICPC_contra_ipsiocd.csv"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS=","
...
USE ALL.
FILTER OFF.
SELECT IF NOT (subject = 1 OR subject = 10 OR subject = 18 OR subject = 21 OR subject = 23 OR subject = 31).
EXECUTE.
