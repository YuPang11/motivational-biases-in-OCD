...
file_f2_csv = fullfile(dir_out, 'M16_f2_drawshc.csv');
out_tiff    = fullfile(dir_out, 'M16_beta_distribution_70x26mm_Compact.tif');
...
set(ax2, 'XColor', 'k');  % Keep axis line visible in black
